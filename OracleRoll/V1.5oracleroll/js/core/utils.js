...
const ICON_LIBRARY = {
  ...
  lyre: `<path d="M8 21c-2 0-3.5-1.5-3.5-3.5V6A3 3 0 0 1 7.5 3h1"/>
         <path d="M16 21c2 0 3.5-1.5 3.5-3.5V6A3 3 0 0 0 16.5 3h-1"/>
         <line x1="6" y1="9" x2="18" y2="9"/>
         <line x1="8.5" y1="12" x2="8.5" y2="18"/>
         <line x1="12" y1="12" x2="12" y2="18"/>
         <line x1="15.5" y1="12" x2="15.5" y2="18"/>`,
  helm: `<path d="M8 15c0-5 0-8 4-8s4 3 4 8"/>
         <path d="M8 15c-1.2 0-2-.8-2-2v-1H4v1.5C4 15.2 5 16 6.5 16z"/>
         <path d="M16 15c1.2 0 2-.8 2-2v-1h2v1.5c0 1.7-1 2.5-2.5 2.5z"/>
         <line x1="10" y1="15" x2="14" y2="15"/>
         <line x1="12" y1="7" x2="12" y2="3.5"/>
         <circle cx="12" cy="3" r="0.8" fill="currentColor" stroke="none"/>`,
  fist: `<path d="M7 9l2.5-4c.7-1 2.3-1 3 .2.8-1 2.6-1 3.4.3 1-.7 2.6.4 2.6 1.8 0 .4-.1.8-.4 1.1.9-.1 1.9.9 1.9 2 0 .7-.4 1.4-1.1 1.7.4.4.6 1 .6 1.7V16c0 2.4-2 4-4.4 4H12c-2.7 0-4.5-1.5-5-3.8-.2-.9-.3-1.6 0-2.4.4-1 .3-2.1-.4-2.9-.4-.5-.5-1.2-.1-1.8z"/>`,
  bow: `<path d="M6 4c8 2 11 6 11 9"/>
         <path d="M6 20c8-2 11-6 11-9"/>
         <line x1="5.6" y1="3.6" x2="5.6" y2="20.4"/>
         <circle cx="17.5" cy="13.5" r="1.2" fill="currentColor" stroke="none"/>`,
  dagger: `<path d="M11 3l2 2-8 11.5A2.2 2.2 0 0 1 1.8 14z"/>
           <line x1="8" y1="10" x2="12" y2="14"/>
           <line x1="5" y1="14" x2="13" y2="22"/>
           <line x1="9.5" y1="14" x2="10.5" y2="18"/>`,
  wand: `<path d="M7 21L21 7"/>
         <line x1="15.5" y1="7.5" x2="16.5" y2="8.5"/>
         <circle cx="5" cy="19" r="2.2"/>
         <path d="M5 11.5l1.1 2.3 2.4.3-1.8 1.6.5 2.4-2.2-1.3-2.2 1.3.5-2.4-1.8-1.6 2.4-.3z"/>`,
  pentagram: `<circle cx="12" cy="12" r="9"/>
              <path d="M12 4l2.4 5.2 5.6.7-4.1 3.9 1 5.5-4.9-2.6-4.9 2.6 1-5.5-4.1-3.9 5.6-.7z"/>`,
  dragon: `<path d="M12 5c-4.2 0-8 3.6-8 8.5h16C20 8.6 16.2 5 12 5z"/>
           <path d="M12 13.5c0 3.6-1.8 5.5-3.5 6.5"/>
           <path d="M12 13.5c0 3.6 1.8 5.5 3.5 6.5"/>
           <path d="M6 13.5l-2.5 3M18 13.5l2.5 3"/>
           <circle cx="9.3" cy="10.5" r="0.9" fill="currentColor" stroke="none"/>
           <circle cx="14.7" cy="10.5" r="0.9" fill="currentColor" stroke="none"/>`,
  sparkle: `<path d="M12 2l2 7.5L22 12l-8 2.5L12 22l-2-7.5L2 12l8-2.5z"/>`,
  horns: `<path d="M9 4c-3.5.8-5.5 3.6-4.5 8"/>
          <path d="M15 4c3.5.8 5.5 3.6 4.5 8"/>
          <path d="M6.5 15.5c1 2.6 3.2 3.9 5.5 3.9s4.5-1.3 5.5-3.9"/>
          <circle cx="9.2" cy="11.8" r="0.9" fill="currentColor" stroke="none"/>
          <circle cx="14.8" cy="11.8" r="0.9" fill="currentColor" stroke="none"/>`
};
...
const ICON_LABELS = {
  ...
  lyre: "Lyre", helm: "Heaume", fist: "Poing", bow: "Arc", dagger: "Dague",
  wand: "Baguette", pentagram: "Pentagramme", dragon: "Dragon", sparkle: "Étincelle", horns: "Cornes"
};
